...
and LispWorks has different behavior when test feature, for example it will not report an error
when there are additional argument in feature expression
